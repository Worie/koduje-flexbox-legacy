...
(function (interactiveEbook) {
  ...
  interactiveEbook.channelSupport = function (_ref) {
    var createChannelSelector = _ref.createChannelSelector,
        dropChannelSelector = _ref.dropChannelSelector,
        clientLinkSelector = _ref.clientLinkSelector,
        channelRenderer = _ref.channelRenderer;

    var createChannel = document.querySelector(createChannelSelector);
    var dropChannel = document.querySelector(dropChannelSelector);
    var clientLink = document.querySelector(clientLinkSelector);

    var dropChannelInnerText = dropChannel.innerText;

    var getClientLink = function getClientLink(channelId) {
      return location.href.replace('index.html', 'client.html') + '?channel=' + channelId;
    };
    var toggleButton = function toggleButton() {
      createChannel.style.display = 'none';
      dropChannel.style.display = 'inline';
    };
    var unToggleButton = function unToggleButton() {
      createChannel.style.display = 'inline';
      dropChannel.style.display = 'none';
    };
    var renderClientLink = function renderClientLink(link) {
      if (link) {
      ...
      clientLink.style.display = !!link ? 'block' : 'none';
    };
    var onChannelCreated = function onChannelCreated(channelId) {
      toggleButton();
    ...
    var restoreOrCreate = function restoreOrCreate() {
      ...
      if (channelId) {
        ...
        channelRenderer.install().then(onChannelCreated).then(function (channelId) {
          window.localStorage.setItem('channelId', channelId);
        });
      }
    };
    var dropChannelClickListener = function dropChannelClickListener() {
...
require('./prepareContent.js');

require('./channelSupport.js');

require('./renderer/embeddedIframe.js');

require('./renderer/spawnedWindow.js');

require('./renderer/channel.js');
...
(function (interactiveEbook) {
  ...
  document.querySelectorAll('.code-fragment').forEach(function (span) {
    span.addEventListener('dblclick', function () {
      window.getSelection().selectAllChildren(span);
    });
  });

  var spawnWindowSelector = '#spawnWindow';
  //  const createChannelSelector = '#createChannel';
  //  const dropChannelSelector = '#dropChannel';
  var clientLinkSelector = '#clientLink';

  var exerciseEl = document.querySelector('.exercise');
  var mainContentWrapperEl = document.querySelector('.exercise-content-wrapper');
  var previewContainerEl = document.querySelector('.exercise-preview');
  var contentEl = document.querySelector('.exercise-content');
  //  let $payModal = $('#payModal');

  var init = function init() {
    var _interactiveEbook$ren = interactiveEbook.renderers.embeddedIframe(previewContainerEl),
        iframeRender = _interactiveEbook$ren.render,
        iframeInstall = _interactiveEbook$ren.install,
        iframeTeardown = _interactiveEbook$ren.teardown;

    interactiveEbook.spawned = interactiveEbook.renderers.spawnedWindow();

    var _interactiveEbook$spa = interactiveEbook.spawned,
        spawnedWindowRender = _interactiveEbook$spa.render,
        spawnedWindowInstall = _interactiveEbook$spa.install,
        spawnedWindowTeardown = _interactiveEbook$spa.teardown;


    var channelRenderer = interactiveEbook.renderers.channel();
    ...
    var renderEverywhere = function renderEverywhere(snippet) {
      iframeRender(snippet);
      spawnedWindowRender(snippet);
      channelRenderer.render(snippet);
    };

    var _interactiveEbook$pre = interactiveEbook.prepareContent({
      renderEverywhere: renderEverywhere,
      contentEl: contentEl,
      snippetAttr: 'data-snippet-name'
    }),
        getSnippetByPageYOffset = _interactiveEbook$pre.getSnippetByPageYOffset;

    window.interactiveEbook.lastRenderedSnippet = null;;

    var scrollListener = function scrollListener() {
      var snippetToBeRendered = getSnippetByPageYOffset(mainContentWrapperEl.scrollTop);
    ...
    var clientInstallListener = function clientInstallListener(event) {
    ...
    var spawnWindowClickListener = function spawnWindowClickListener() {
...
},{"./channelSupport.js":1,"./common.js":2,"./prepareContent.js":9,"./renderer/channel.js":10,"./renderer/embeddedIframe.js":11,"./renderer/spawnedWindow.js":12,"./splitView.js":13,"./tooltips.js":14,"./view.js":15,"./youtube.js":16,"./youtubeLinks.js":17,"array-includes":30}],4:[function(require,module,exports){
'use strict';
...
var _flexAxis = require('./internal/flexAxis');

var _flexAxis2 = _interopRequireDefault(_flexAxis);

var _setupAnchors = require('./internal/setupAnchors');

var _setupAnchors2 = _interopRequireDefault(_setupAnchors);
...
exports.default = function (config) {
  ...
  var stringifyModule = function stringifyModule(module) {
    // get rid of function notation
    modules.push(module.toString().replace(/function\s*\(.*\)\s*\{([^]*)\}$/, '$1'));
  };

  stringifyModule(_flexAxis2.default);
  stringifyModule(_setupAnchors2.default);

  return modules;
};

},{"./internal/flexAxis":6,"./internal/setupAnchors":7}],5:[function(require,module,exports){
"use strict";
...
exports.default = function (moduleConfig) {
  var document = moduleConfig.document;
...
exports.default = function (moduleConfig) {
  ...
  var setupInternal = function setupInternal() {
    var baseHref = document.querySelector('base[data-snippet-locked]').getAttribute('href');
...
var mobilePagination = document.querySelector('.mobile-pagination');
var exerciseSection = document.querySelector('.exercise');

mobilePagination.addEventListener('click', function (ev) {
  if (ev.target.matches('span')) {
    mobilePagination.querySelectorAll('li').forEach(function (li) {
...
(function (interactiveEbook) {
  ...
  interactiveEbook.prepareContent = function (_ref) {
    var renderEverywhere = _ref.renderEverywhere,
        snippetAttr = _ref.snippetAttr,
        contentEl = _ref.contentEl;

    var contentBreakpoints = {};

    var mainContentWrapperEl = document.querySelector('.exercise-content-wrapper');
    var requestZippedSnippet = function requestZippedSnippet(datali, zipName) {
      ...
      xmlhttp.send(JSON.stringify({ data: data, zipName: zipName }));
    };
    var exerciseSectionEl = document.querySelector('.exercise');
    ...
    var lineIndicatorYPosition = window.innerHeight / 2;

    var activeSnippetName = void 0;
    var setActive = function setActive(breakpoint) {
      activeSnippetName = breakpoint.snippetName;

      updateActiveBookElement(activeSnippetName);
    };

    var activeBookElement = void 0;
    var updateActiveBookElement = function updateActiveBookElement(activeSnippetName) {
      ...
      var editors = document.querySelectorAll('[data-snippet-cm=' + activeSnippetName + ']');
      ...
      (function (cm) {
        if (cm) cm.refresh();
      })(CMList[activeSnippetName].find(function (cm) {
        return cm.getOption('activeCM');
      }));
    };

    var linkSnippetsWithElements = function linkSnippetsWithElements() {
      var breakpointElements = document.querySelectorAll('[' + snippetAttr + ']');
      for (var i = 0, ilen = breakpointElements.length; i < ilen; i++) {
        var boundingBox = breakpointElements[i].getBoundingClientRect();
        // todo calculate a center point
        var p = parseInt(breakpointElements[i].offsetTop) - parseInt(parseInt(window.innerHeight) / 2) - 200;
        if (p < 0) {
          p = 0;
        }
    ...
    var prepareBreakpoints = function prepareBreakpoints(DOC_HEIGHT) {
      var currentBreakpoint = null;
      for (var i = 0, ilen = parseInt(getComputedStyle(contentEl).height) + (window.innerHeight - lineIndicatorYPosition); i < ilen; i++) {
    ...
    var DOC_HEIGHT = parseInt(getComputedStyle(contentEl).height) + (window.innerHeight - lineIndicatorYPosition);
    ...
    var getSnippetByPageYOffset = function getSnippetByPageYOffset(pageYOffset) {
      var breakpoint = contentBreakpoints[pageYOffset];
      if (!breakpoint) {
        return;
      }
    ...
    var addCircularMenu = function addCircularMenu(parent, options) {
      ...
      menuTrigger.addEventListener('click', function (ev) {
        ...
        Array.from(ul.querySelectorAll('button')).forEach(function (button) {
      ...
      btns.forEach(function (btn) {
        ...
        if (btn.attr) {
          Object.keys(btn.attr).forEach(function (attr) {
    ...
    var loadSnippets = function loadSnippets() {
      ...
      var snippetTriggers = document.querySelectorAll('[' + snippetAttr + ']');
      snippetTriggers.forEach(function (el) {
        var snippetName = el.getAttribute(snippetAttr);
        var snippetData = interactiveEbook.snippets[el.getAttribute(snippetAttr)];

        var snippetFiles = snippetData.files;

        var fileNamesToBeRendered = Array.from(el.getAttribute('data-snippet-files').split(','));
        ...
        addCircularMenu(el, {
          btns: [{
            ...
            action: function action(self) {
              CMList[snippetName].forEach(function (cm) {
                cm.setValue(cm.originalFile.contents);
                cm.originalFile.markers.forEach(function (marker) {
          ...
          //                  action: (self) => {
          //                    requestZippedSnippet(snippetFiles, snippetName);
          //                  }
          //                },
          {
        ...
        snippetFiles.forEach(function (file) {
          ...
          cm.on('change', function (cm, change) {
            var snippet = interactiveEbook.snippets[el.dataset.snippetName];
          ...
          if (el.getAttribute('data-snippet-main') == file.fileName || file.fileName === fileNamesToBeRendered[0] && !el.getAttribute('data-snippet-main')) {
          ...
          cms.push(cm);
          var markers = file.markers.forEach(function (marker) {
            cm.markText(marker.from, marker.to, marker.options);
          });
        });
      ...
      var renderlessSnippets = document.querySelectorAll(".renderlessSnippet");
      renderlessSnippets.forEach(function (el) {
    ...
    window.addEventListener('resize', function () {
      ...
      linkSnippetsWithElements();
      prepareBreakpoints(parseInt(getComputedStyle(contentEl).height) + (window.innerHeight - lineIndicatorYPosition));
    });
    return { getSnippetByPageYOffset: getSnippetByPageYOffset };
  };
})(function (global) {
  global.interactiveEbook = global.interactiveEbook || {};
  return global.interactiveEbook;
...
},{"codemirror/addon/display/autorefresh":33,"codemirror/addon/edit/closebrackets":34,"codemirror/addon/edit/closetag":35,"codemirror/addon/edit/matchbrackets":36,"codemirror/addon/edit/matchtags":37,"codemirror/addon/hint/css-hint":39,"codemirror/addon/hint/html-hint":40,"codemirror/addon/hint/javascript-hint":41,"codemirror/addon/hint/show-hint":42,"codemirror/lib/codemirror":44,"codemirror/mode/css/css":45,"codemirror/mode/htmlmixed/htmlmixed":46,"codemirror/mode/javascript/javascript":47,"codemirror/mode/xml/xml":48}],10:[function(require,module,exports){
'use strict';

(function (interactiveEbook) {
  'use strict';

  var channelsEndpoint = 'http://localhost:8000/channel';
  var mode = 'cors';

  interactiveEbook.renderers.channel = function () {
    var channelId = void 0;

    var install = function install(existingChannelId) {
    ...
    var render = function render(snippet) {
      if (!channelId) {
        return;
      }
    ...
    return { install: install, render: render, teardown: teardown };
  };
})(function (global) {
  global.interactiveEbook = global.interactiveEbook || {};
...
var _internal = require('../lib/iframe/internal.js');

var _internal2 = _interopRequireDefault(_internal);

var _getEmbeddedInternalScript = require('../lib/iframe/getEmbeddedInternalScript.js');

var _getEmbeddedInternalScript2 = _interopRequireDefault(_getEmbeddedInternalScript);
...
(function (interactiveEbook) {
  ...
  var _interactiveEbook$com = interactiveEbook.common,
      getIframeWindow = _interactiveEbook$com.getIframeWindow,
      sendSnippet = _interactiveEbook$com.sendSnippet,
      injectScript = _interactiveEbook$com.injectScript,
      styleIframe = _interactiveEbook$com.styleIframe;


  window.internalConfig = {
    chapterId: window.interactiveEbook.chapterId,
    modules: (0, _getEmbeddedInternalScript2.default)()
  };

  interactiveEbook.renderers.embeddedIframe = function (rendererContainer) {
    var iframe = void 0;

    var setupIframe = function setupIframe(iframeWindow) {
      var iframeDoc = iframeWindow.document;
      injectScript(iframeDoc, 'assets/js/iframe.js');
      var scriptEl = iframeDoc.createElement('script');
      scriptEl.innerHTML = 'window.internal = {config: ' + JSON.stringify(internalConfig) + ',script: ' + _internal2.default + '};';
...
},{"../lib/iframe/getEmbeddedInternalScript.js":4,"../lib/iframe/internal.js":5}],12:[function(require,module,exports){
'use strict';
...
(function (interactiveEbook) {
  ...
  var sendSnippet = interactiveEbook.common.sendSnippet;


  var spawnedWindow = void 0;

  interactiveEbook.renderers.spawnedWindow = function () {
    window.internalConfig = {
      chapterId: window.interactiveEbook.chapterId,
      modules: (0, _getEmbeddedInternalScript2.default)()
    };

    var install = function install(trigger) {
      // If we wanted to avoid having client.html we may create it on the go
      // just as we create iframe.
      //
      // html can pe passed inline as long as we have client.js url.
      //      let server = location.origin;
      var server = location.href;

      var internalScriptEl = '<script>window.internal = {config: ' + JSON.stringify(internalConfig) + ',script: ' + _internal2.default + '};</script>';
...
},{"../lib/iframe/getEmbeddedInternalScript.js":4,"../lib/iframe/internal.js":5}],13:[function(require,module,exports){
'use strict';
...
var _managementPanel = require('../managementPanel.js');

var _managementPanel2 = _interopRequireDefault(_managementPanel);

var _panelButton = require('../panelButton.js');

var _panelButton2 = _interopRequireDefault(_panelButton);

var _ui2 = require('../ui.js');
...
(0, _jquery2.default)('.exercise-content').focus();

var exerciseSectionEl = document.querySelector('.exercise');
var managementPanel = (0, _managementPanel2.default)({
...
managementPanel.add({
  entity: (0, _panelButton2.default)({
...
var nextBtn = (0, _panelButton2.default)({
...
var prevBtn = (0, _panelButton2.default)({
...
var spawnButton = (0, _panelButton2.default)({
...
var previewButton = (0, _panelButton2.default)({
...
if (window.interactiveEbook.ytUrl) {
  var videoButton = (0, _panelButton2.default)({
...
var desktopViewport = window.matchMedia(mediaQueries.medium);
var desktopViewportHandler = function desktopViewportHandler(mql) {
...
},{"../managementPanel.js":25,"../panelButton.js":27,"../ui.js":28,"jquery":69}],14:[function(require,module,exports){
'use strict';

var explainableTooltip = null;
// used for aria
var tooltipCount = 0;

var explainableList = Array.from(document.querySelectorAll('.explainable'));
explainableList.forEach(function (el) {
...
var removeTooltips = function removeTooltips() {
...
var showTooltip = function showTooltip(options) {
  ...
  var tooltipWrapperEl = document.createElement('div');
  ...
  // stupid workaround for path replacement in standalone exercises (it replaces ../images/ to ../images)
  ...
  var tooltipBodyEl = document.createElement('div');
...
var wrapperEl = document.querySelector('.exercise-content-wrapper');
...
require('./mobilePagination.js');

exports.default = function () {

  var hideUIElements = function hideUIElements() {};
};

},{"./mobilePagination.js":8,"./splitView.js":13}],16:[function(require,module,exports){
'use strict';
...
},{"youtube-iframe":74}],17:[function(require,module,exports){
'use strict';

window.interactiveEbook = window.interactiveEbook || {};

var links = Array.from(document.querySelectorAll('.youtube-time'));
links.forEach(function (link) {
  link.addEventListener('click', function () {
    var timeArray = link.getAttribute('data-yt-time').split(":");
    var time = 0;
    // Minutes to seconds
...
exports.default = function () {
  var $labels = (0, _jquery2.default)('.floating-label');

  _jquery2.default.each($labels, function () {
    var $label = (0, _jquery2.default)(this);
    // Every formControl is a certain sibling of a label.
    var $formControl = $label.siblings('input, select, textarea');
    var $errorList = $formControl.siblings('ul');

    var formControlHandler = function formControlHandler() {
      $label.toggleClass('expanded', Boolean($formControl.val()));
    };

    // Init labels.
    formControlHandler();

    // Check if there is an error list when the form control is not empty and
    // hide the label when the list is visible.
    if ($formControl.val() && $errorList.length && $errorList.css('opacity') !== '0') {
      $label.removeClass('expanded');
    }

    $formControl.on('input', formControlHandler);

    // Presence of this class enables the animation of floating labels.
    (0, _jquery2.default)(document).ready(function () {
      $label.addClass('smooth');
    });
  });
};

},{"jquery":69}],19:[function(require,module,exports){
'use strict';
...
exports.default = function () {
  var paymentMethodSelector = document.querySelector('select[name="paymentMethod"]');
  var paymentForm = document.querySelector('.payment-form');
  var cardMethodInputs = document.querySelectorAll('.method-card input, .method-card select');
  var transferMethodInputs = document.querySelectorAll('.method-transfer input, .method-transfer select');

  if (paymentForm) {
    paymentMethodSelector.addEventListener('change', function () {
      var selectedType = this.value;

      paymentForm.dataset.type = selectedType;

      if (selectedType === 'card') {
        [].concat(_toConsumableArray(cardMethodInputs)).forEach(function (el) {
          el.required = true;
        });

        [].concat(_toConsumableArray(transferMethodInputs)).forEach(function (el) {
          el.required = false;
        });
      } else {
        [].concat(_toConsumableArray(cardMethodInputs)).forEach(function (el) {
...
exports.default = function () {
  ...
  var init = function init() {
    dropdownTrigger.addEventListener('click', toggle);
  };

  var show = function show() {
    dropdownMenu.classList.add('navbar-dropdown-open');
  };

  var toggle = function toggle(mode) {
    dropdownMenu.classList.toggle('navbar-dropdown-open');
  };

  var hide = function hide() {
    dropdownMenu.classList.remove('navbar-dropdown-open');
  };
...
var _navbarDropdown = require('./UIElements/navbarDropdown');
...
exports.default = function () {
  ...
  var navbarDropdown = (0, _navbarDropdown2.default)();

  var hideUIElements = function hideUIElements() {
    navbarDropdown.hide();
  };

  // I wanted to add 'onAction' or something like that
  // so I could easly manage the view whenever someone scrolls the book, click elements on page etc.
  // when those actions occur, we would like to hide modal for example, or hide navbarDropdown or hide explainableTooltips
...
},{"./UIElements/navbarDropdown":20}],22:[function(require,module,exports){
'use strict';
...
exports.default = function () {
  ...
  // Add every element you want to be sticky here.
  var $stickyElements = Array.from(document.querySelectorAll(['.product-summary', '.payment-summary', '.profile-navigation'].join(', ')));
...
},{"stickyfill":73}],23:[function(require,module,exports){
'use strict';
...
var _stickyElements = require('./global/stickyElements');

var _stickyElements2 = _interopRequireDefault(_stickyElements);

var _floatingLabels = require('./forms/floatingLabels');

var _floatingLabels2 = _interopRequireDefault(_floatingLabels);

var _paymentForm = require('./forms/paymentForm');

var _paymentForm2 = _interopRequireDefault(_paymentForm);

var _noTouch = require('./noTouch');

var _noTouch2 = _interopRequireDefault(_noTouch);

require('./exercise/exercise');

var _UIManager = require('./global/UIManager');
...
var init = function init() {
  (0, _stickyElements2.default)();
  (0, _floatingLabels2.default)();
  (0, _paymentForm2.default)();
  (0, _UIManager2.default)();
...
},{"./exercise/exercise":3,"./forms/floatingLabels":18,"./forms/paymentForm":19,"./global/UIManager":21,"./global/stickyElements":22,"./noTouch":26}],25:[function(require,module,exports){
'use strict';
...
exports.default = function (_ref) {
  ...
  var rootEl = document.createElement('nav');
  ...
  var createGroup = function createGroup(name) {
    if (groupMap.has(name)) {
      return groupMap.get(name);
    }

    var theGroup = (0, _group2.default)({
  ...
  var removeGroup = function removeGroup(name) {
    if (!groupMap.has(name)) {
      return false;
    }
...
},{"./group.js":23}],26:[function(require,module,exports){
'use strict';

var enabled = true;

var setTouchMode = function setTouchMode(bool) {
  document.body.classList.toggle('no-touch', !bool);
};
...
exports.default = function (_ref) {
  ...
  if (defaultState) rootEl.classList.add('active');
...
exports.default = function () {
  ...
  var $previewEl = (0, _jquery2.default)('.exercise-preview');
  var $videoEl = (0, _jquery2.default)('.exercise-video');

  var createVertical = function createVertical() {
    if (vertical) return;

    vertical = (0, _split2.default)(['.exercise-preview', '.exercise-video'], {
      gutterSize: 10,
      minSize: [100, 100],
      direction: 'vertical'
    });
  ...
  var createHorizontal = function createHorizontal() {
    ...
    horizontal = (0, _split2.default)(['.exercise-content-wrapper', '.exercise-aside-wrapper'], {
      sizes: [65, 35],
  ...
  var destroyHorizontal = function destroyHorizontal() {
    if (!horizontal) return;
    horizontal.destroy();
    horizontal = null;
  };

  var destroyVertical = function destroyVertical() {
    if (!vertical) return;
    vertical.destroy();
    vertical = null;
  };
  ...
  var showBoth = function showBoth() {
    createHorizontal();
    createVertical();
  };
...
},{"jquery":69,"split.js":72}],29:[function(require,module,exports){
(function (global){
'use strict';
...
},{"es-abstract/es6":51}],30:[function(require,module,exports){
'use strict';
...
},{"./implementation":29,"./polyfill":31,"./shim":32,"define-properties":49,"es-abstract/es6":51}],31:[function(require,module,exports){
'use strict';
...
},{"./polyfill":31,"define-properties":49}],33:[function(require,module,exports){
...
},{"../../lib/codemirror":44}],34:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":44,"../fold/xml-fold":38}],36:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":44,"../fold/xml-fold":38}],38:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":44,"../../mode/css/css":45}],40:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":44,"./xml-hint":43}],41:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":44}],44:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":44,"../css/css":45,"../javascript/javascript":47,"../xml/xml":48}],47:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":44}],48:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":44}],49:[function(require,module,exports){
'use strict';
...
},{"foreach":61,"object-keys":70}],50:[function(require,module,exports){
'use strict';
...
},{"./helpers/isFinite":53,"./helpers/isNaN":54,"./helpers/mod":56,"./helpers/sign":57,"es-to-primitive/es5":58,"is-callable":65}],51:[function(require,module,exports){
'use strict';
...
},{"./es5":50,"./helpers/assign":52,"./helpers/isFinite":53,"./helpers/isNaN":54,"./helpers/isPrimitive":55,"./helpers/mod":56,"./helpers/sign":57,"es-to-primitive/es6":59,"function-bind":63,"is-regex":67}],52:[function(require,module,exports){
...
},{"./helpers/isPrimitive":60,"is-callable":65}],59:[function(require,module,exports){
'use strict';
...
},{"./helpers/isPrimitive":60,"is-callable":65,"is-date-object":66,"is-symbol":68}],60:[function(require,module,exports){
...
},{"has":64}],68:[function(require,module,exports){
'use strict';
